	...
	render() {
		...
		return (
			<div className="UserHeader">
				<img className="UserHeader-avatar" src={user.basics.picture} alt={user.basics.name} />
				<div className="details">
					<span className="title">{user.basics.name}</span>
					<h4>
						<a href={`${GIT_CONNECTED_BASE_URL}${user.basics.username}`}
						target="_blank"
					...
					<span>{user.basics.yearsOfExperience} years of experience as a developer.</span>
